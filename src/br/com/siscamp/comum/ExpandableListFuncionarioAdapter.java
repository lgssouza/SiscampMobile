...
public class ExpandableListFuncionarioAdapter extends BaseExpandableListAdapter {

	Context context;
	String[] listaPai;
	String[][] listafilho;

	public ExpandableListFuncionarioAdapter(Context context, String[] listaPai, String[][] listafilho) {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
		...
		// Criei um TextView que conterá as informações da sublista que
