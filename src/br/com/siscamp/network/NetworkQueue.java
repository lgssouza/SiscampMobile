...
public class NetworkQueue {
	...
	public void doGet(String url, Object tag, NetworkRequestCallback<JSONObject> networkRequestCallback) {
		JsonObjectRequest jsonObjectRequest = buildJSONRequest(Request.Method.GET, url, null, tag,
	...
	public void doGetArray(String url, Object tag, NetworkRequestCallback<JSONArray> networkRequestCallback) {
		JsonArrayRequest jsonArrayRequest = buildJSONRequest(url, tag, networkRequestCallback);
	...
	public void doPost(String url, JSONObject jsonObject, Object tag,
		...
		JsonObjectRequest jsonObjectRequest = buildJSONRequest(Request.Method.POST, url, jsonObject, tag,
				networkRequestCallback);
		doRequest(jsonObjectRequest);
	}
